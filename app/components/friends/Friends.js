...
export default function Friends() {
    const { initialized, initializeUser, loading, removeFriend, transactionPending, sendFriendRequest, acceptFriendRequest, friends, name, requests, sentRequests, allProfileAccounts ,bio} = useUserProfile();
